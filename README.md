...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    - A describe block (describe()) is a way to group your tests (it()). You could write your test globally (outside of a describe block) for general tests perhaps like a snapshot, however it is popular opinion to nest tests within a describe() keep your code clean. 

1. What is the point of `Test Driven Development`? What do you think about this approach?

    - Test Driven Development (TDD) is useful for helping to define what the application of funtions should do.  Write what the app should do, then write the app to pass the test.  This is also helpful in catching bugs, especially if making changes to the code later.

1. Mention three types of automated tests.

    - Unit testing: tests for smaller chunks of software such as functions or looking for a specific component to be rendered.

    - Integration testing: testing groups of functions or features to be sure they work together.

    - End-to-end testing: testing the application as a whole in a 'real-world' scenario.
